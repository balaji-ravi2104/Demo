...
public class Scross extends Car {
    ...
    private static final int defaultAirbagSize = 2;
    ...
    public void setAirBag(int airBag) throws CustomException{
    	   UtilMethods.isPositionValid(airBag,defaultAirbagSize,"Airbag size must be greater than zero and must be less than 3");
        this.airBag = airBag;
    }
