...
public class MainController {
	...
	private void preformAdminOperation(User user2) {
		...
		while (isAdminAlive) {
			...
			log.info("4. View Employees in One Branch");
			log.info("5. View All Employees From Accross All Branch");
			log.info("6. Create User");
			log.info("7. Create Account");
			log.info("6. Remove Customer");
			log.info("8. View Particular Customer");
			log.info("9. View All Customer");
			log.info("10. View Particular Customer One Branch Transaction");
			log.info("11. View Particular Customer All Branch Transaction");
			log.info("12. View Particular Branch Transaction");
			log.info("13. View All Branch Transaction");
			log.info("14. Exit");
			log.info("Enter the choice");
