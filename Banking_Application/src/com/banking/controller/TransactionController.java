...
public class TransactionController {
	...
	public List<Transaction> getAllCustomerTransaction(int branchId) throws CustomException {
		List<Transaction> transactionHistory = null;
		try {
			transactionHistory = transactionDao.getAllCustomerTransactionHistory(branchId);
		}catch (Exception e) {
			throw new CustomException("Error while Getting Transaction History!!!",e);
		}
		return transactionHistory;
